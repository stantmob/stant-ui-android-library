...
public class IncreaseDecreaseButtonsViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mIncreaseDecreaseButtonsViewTestActBinding.increaseDecreaseButtons.setOnPressIncreaseButton(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(IncreaseDecreaseButtonsViewActivity.this, "Increase Button Action", Toast.LENGTH_SHORT).show();
            }
        });

        mIncreaseDecreaseButtonsViewTestActBinding.increaseDecreaseButtons.setOnPressDecreaseButton(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(IncreaseDecreaseButtonsViewActivity.this, "Decrease Button Action", Toast.LENGTH_SHORT).show();
            }
        });
